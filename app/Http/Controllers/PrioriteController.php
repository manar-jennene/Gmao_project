...
class PrioriteController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            return response()->json($priorite, 200);
        } catch (\Exception $e) {
    ...
    public function store(Request $request)
    {
        try {
            ...
            return response()->json(['message' => 'Statut ajouté avec succès', 'libelle' => $priorite->libelle], 201);
        } catch (\Exception $e) {
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $priorite->libelle = $validatedData['libelle'];
            ...
            return response()->json(['error' => 'priorite non trouvé pour la mise à jour'], 404);
    ...
    public function destroy($id)
    {
        try {
            ...
            return response()->json(['message' => 'priorite supprimé avec succès'], 200);

        } catch (ModelNotFoundException $e) {
            return response()->json(['error' => 'priorite non trouvé pour la suppression'], 404);
        } catch (\Exception $e) {
            ...
            // Vous pourriez vouloir vérifier spécifiquement les erreurs de contrainte FK
             if (str_contains($e->getMessage(), 'Integrity constraint violation')) {
                 return response()->json(['error' => 'Impossible de priorite ce statut car il est utilisé ailleurs.'], 409); // 409 Conflict
             }
